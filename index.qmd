...
p %>% layout(yaxis=list(title=""),xaxis=list(title="Разница в количестве людей 2018 и 2024 гг., %"),legend = list(orientation = 'h',title = list(text = "За Путина?"),y = 1,x=0.2))
```
